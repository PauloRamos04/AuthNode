...
app.post('/auth/register', async(req, res) =>{
    ...
    if(password !== confirmpassword){
        return res.status(422).json({msg: 'As senhas não sao conferem!'})
    }
    //check if user exist
...
mongoose
    .connect(`mongodb+srv://${dbUser}:${dbPassword}@cluster0.betaghc.mongodb.net/?retryWrites=true&w=majority`)
    .then(()=>{
        app.listen(3000)
